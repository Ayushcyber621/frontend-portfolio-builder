...
const navItems = [
  ...
  { name: "Resume", href: "/resume.pdf", icon: Download, isDownload: true },
      ...
      {navItems.map((item) => {
        ...
        if (item.isDownload) {
          return (
            ...
            >
              <div
                className="p-3 rounded-full bg-background/80 backdrop-blur-md border border-border shadow-lg hover:bg-primary hover:text-primary-foreground transition-all duration-300"
              >
